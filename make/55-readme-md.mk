...
$(CLOUDSITE_README_BUILT): $(CLOUDSITE_README_PREFIX) $(CLOUDSITE_README_SUFFIX) $(CLOUDSITE_CLI_DEF) $(SDLC_CLOUDSITE_EXEC_JS)
	cp $(CLOUDSITE_README_PREFIX) $@
	echo >> $@
	$(SDLC_CLOUDSITE_EXEC_JS) --no-reminders document --section-depth 2 >> $@
