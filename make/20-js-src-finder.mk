...
SDLC_JS_SELECTOR=\( -name "*.js" -o -name "*.cjs" -o -name "*.mjs" \) -not -path "*/node_modules/*"  -not -path "*/site/*"
SDLC_TEST_SELECTOR=\( -name "*.test.*js" -o -path "*/test/*" \) -not -path "*/site/*"

# all source, non-test files (cli and lib)
SDLC_ALL_JS_FILES_SRC:=$(shell find $(SRC) $(SDLC_JS_SELECTOR) -not $(SDLC_DATA_SELECTOR) -type f -not -path '*/node_modules/*')
